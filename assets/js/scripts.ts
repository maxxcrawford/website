...
(function() {
	...
	function setPlaceholder(number: number) {
		var formName = document.querySelector(".formName") as HTMLInputElement;
		var formEmail = document.querySelector(".formEmail") as HTMLInputElement;
		var formMessage = document.querySelector(".formMessage") as HTMLInputElement;
